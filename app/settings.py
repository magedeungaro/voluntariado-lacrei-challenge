...
DATABASES = {
    "default": {
        ...
        "PASSWORD": config("DB_PASSWORD", default="lacrei_password"),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API REST para gerenciamento de profissionais de saúde e consultas",
    "VERSION": "1.0.0",
...
# OAuth2 settings (django-oauth-toolkit)
OAUTH2_PROVIDER = {
    "SCOPES": {
        "read": "Read access",
        "write": "Write access",
