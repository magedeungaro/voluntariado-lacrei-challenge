...
resource "aws_security_group" "rds" {
  ...
  # Only allow PostgreSQL from EC2
  ingress {
    from_port       = 5432
    to_port         = 5432
    protocol        = "tcp"
...
# VPC Endpoints for SSM (allows SSM without internet access if needed)
...
# S3 Gateway Endpoint (allows S3 access without internet gateway)
